...
function session(options){
    ...
    var tokenHeaderId = options.tokenheaderid
    ...
    return function session(req, res, next) {
        ...
        // get the session ID from the cookie / header
        var sessionId = req.sessionID = getManualSessionId(req) ? getManualSessionId(req) : getSessionIdFromCookieOrHeader(req, name, secrets, tokenHeaderId);
        ...
        onHeaders(res, function(){
            ...
            setSessionIdOnCookieOrHeader(res, name, req.sessionID, secrets[0], cookie.data, tokenHeaderId);
        });
...
function getSessionIdFromCookieOrHeader(req, name, secrets, tokenHeaderId) {
    var header = req.headers.cookie || req.get(tokenHeaderId);
    var raw;
    var val;
...
function setSessionIdOnCookieOrHeader(res, name, val, secret, options, tokenHeaderId) {
    ...
    res.setHeader(tokenHeaderId, val);
}
